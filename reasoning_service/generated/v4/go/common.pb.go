...
const file_common_proto_rawDesc = "" +
	"\n" +
	"\fcommon.proto\x12\tcommon.v4\"$\n" +
	"\tTimestamp\x12\x17\n" +
	"\aunix_ms\x18\x01 \x01(\x03R\x06unixMs\"V\n" +
	"\vRequestMeta\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12(\n" +
	"\x04time\x18\x02 \x01(\v2\x14.common.v4.TimestampR\x04time\"P\n" +
	"\bResponse\x12*\n" +
	"\x04meta\x18\x01 \x01(\v2\x16.common.v4.RequestMetaR\x04meta\x12\x18\n" +
	...
	"\x05input\x18\x04 \x03(\v2\x1e.common.v4.PlanStep.InputEntryR\x05input\x12'\n" +
	...
	"\x05steps\x18\x02 \x03(\v2\x13.common.v4.PlanStepR\x05steps\x12 \n" +
	"\vconstraints\x18\x03 \x03(\tR\vconstraints\x129\n" +
	"\bmetadata\x18\x04 \x03(\v2\x1d.common.v4.Plan.MetadataEntryR\bmetadata\x1a;\n" +
...
var file_common_proto_goTypes = []any{
	(*Timestamp)(nil),   // 0: common.v4.Timestamp
	(*RequestMeta)(nil), // 1: common.v4.RequestMeta
	(*Response)(nil),    // 2: common.v4.Response
	(*PlanStep)(nil),    // 3: common.v4.PlanStep
	(*Plan)(nil),        // 4: common.v4.Plan
	nil,                 // 5: common.v4.PlanStep.InputEntry
	nil,                 // 6: common.v4.Plan.MetadataEntry
}
var file_common_proto_depIdxs = []int32{
	0, // 0: common.v4.RequestMeta.time:type_name -> common.v4.Timestamp
	1, // 1: common.v4.Response.meta:type_name -> common.v4.RequestMeta
	5, // 2: common.v4.PlanStep.input:type_name -> common.v4.PlanStep.InputEntry
	3, // 3: common.v4.Plan.steps:type_name -> common.v4.PlanStep
	6, // 4: common.v4.Plan.metadata:type_name -> common.v4.Plan.MetadataEntry
