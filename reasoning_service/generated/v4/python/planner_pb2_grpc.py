...
import generated.v4.python.planner_pb2 as planner__pb2
...
class PlannerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HandleGatewayRequestToPlanner = channel.unary_unary(
                '/planner.v4.Planner/HandleGatewayRequestToPlanner',
...
def add_PlannerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'planner.v4.Planner', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('planner.v4.Planner', rpc_method_handlers)
